...
export default function Timer({intervalTime = 5000, radius = 80}) {
  ...
  return (
    <svg className="timer-wrapper" onClick={handleTimerTapping} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height="200" width="200" viewBox="0 0 200 200">
      <circle 
        className="back-ring"
        cx="100" 
        cy="100" 
