...
/* 
  For the current requirements, it is enough to have 1 state that represents both 'initial' and 'paused' modes,
  beacuse from this 'stopped' state, the timer just runs - it doesn't care whether from 'initial or 'paused' modes.
  If a different behavior will be required for each mode, then we'll need 2 separate states.
*/